...
WIKILARGE_DIR=./datasets/wikilarge
TURK_DIR=./datasets/turkcorpus
ASSET_DIR=./datasets/asset
...
EXPERIMENT=wikilarge_experiment
...
# python preprocess_to_wikisplit_format.py \
#       --src-path ${WIKILARGE_DIR}/wikilarge.train.src \
#       --dst-path ${WIKILARGE_DIR}/wikilarge.train.dst \
#       --output-path ${WIKILARGE_DIR}/train.tsv \

# python preprocess_to_wikisplit_format.py \
#       --src-path ${TURK_DIR}/turkcorpus.valid.complex \
#       --dst-path ${TURK_DIR}/turkcorpus.valid.simple.turk.0 \
#       --output-path ${TURK_DIR}/tune.tsv \

### 1. Phrase Vocabulary Optimization

# python phrase_vocabulary_optimization.py \
#   --input_file=${WIKILARGE_DIR}/train.tsv \
